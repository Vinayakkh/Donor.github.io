                                    ...
                                    <form role="form" action="index.php" method="post">
                                        <?php 
                                            if(isset($_POST['name'])){
                                                ...
                                                echo" <a href='..\pages\index.php' div style='text-align: center'><h3>Go Back</h3>";

                                            }

                                            }else{
                                                echo"<h3>YOU ARE NOT AUTHORIZED TO REDIRECT THIS PAGE. GO BACK to <a href='..\pages\index.php'> User Login </a></h3>";
                                            }
...
<h2 style="color:#ff00ff;">Thanks for Being the reason for someone's heartbeat <span style="color:darkred;">&#10084</span></h2>
