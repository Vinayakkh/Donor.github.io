...
body {
  ...
  background-image: url("\donor\userlog\img\getimage.jpg");
...
<body>
  ...
  ?>
				...
				<div class="mt-4">
					...
					<div class="d-flex justify-content-center links">
						<a href="../" style="text-decoration:none; color: white">Back to Admin Panel</a><br>
						<br>
					</div>
						<div class="d-flex justify-content-center links">
								<p style="color: white"> Willing To Become Donor &nbsp;</p><a  href="/userlog/st.php" style="text-decoration: none; color:#66ffff;"><strong>Sign Up</strong></a>	 
								</div>	
